...
object Constant {
    ...
    const val FEISHU_APP_ID_KEY = "FEISHU_APP_ID_KEY"
    const val FEISHU_APP_SECRET_KEY = "FEISHU_APP_SECRET_KEY"
    const val FEISHU_CONTROL_ENABLE_KEY = "FEISHU_CONTROL_ENABLE_KEY"
